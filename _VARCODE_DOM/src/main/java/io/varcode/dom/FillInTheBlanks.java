 ...
 * <PRE><CODE>
 * FillInTheBlanks.FillOrder s = 
 *     FillInTheBlanks.parse( "__ __ __ __ __"); //5 blanks 1 space
 * 
 * System.out.println ( s.fill("A", "B", "C", "D", "E") ); //produces "A B C D E"
 * System.out.println ( s.fill(" ", " ", " ", " ", " ") ); //produces "       "
 * System.out.println ( s.fill("Don't", "disturb", "the", "man", "inside") ); 
 * //produces "Don't disturb the man inside"
 * 
 * FillInTheBlanks.FillOrder c2 = 
 *     FillInTheBlanks.parse( "four score and $$ years ago", "$$" ); //1 blank signified with "$$" token
 *     //                                                     ^^
 *     //                                                     This is the "Blank" indicator      
...
{					
	/** All of the static text as a String */
	public final String staticText;
	
    /** 
     * BitSet representing the char locations within the static text where 
     * blanks occur Indexes within the Static text where text is to be inserted
     * For instance if we had:
     * <PRE>
     * FillInTheBlanks s = FillInTheBlanks.parse(
     ...
     * means a "blank" 
     * where text can be inserted, so we end up with a BitSet with the following
     * contents:
     *   
     * text = "Mary had a  lamb,  lamb,  lamb";
     ...
     *  [29]                         [0]   
     */
	public final BitSet blanks;
	
	public FillInTheBlanks( String staticText, BitSet blanks )
	{
	...
	public static class FillTemplate
	{
		...
		/** the number of blanks in the FillOrder */
		...
		public void fill( TextBuffer out, Object... fillsInOrder )
		    throws VarException
		{
