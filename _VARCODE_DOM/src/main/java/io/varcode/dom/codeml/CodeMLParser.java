...
{   
    ...
    public static class AddVarExpressionMark
    {
         ...
         public static AddVarExpression of( String text )
         {
             return of( text, -1, VarNameAudit.BASE );
         }
         
         public static AddVarExpression of( String text, int lineNumber )
         {
         ...
         public static AddVarExpression of( String text, int lineNumber, VarNameAudit nameAudit )
             throws MarkupException
         {
    ...
    public static class AddVarInlineMark
    {
        ...
        public static AddVarExpression of( 
    ...
    public static class AddScriptResultInlineMark
    {
        ...
        try
        {
            nameAudit.audit( scriptName );
        }
        catch( Exception e )
        {
            throw new MarkupException( 
                "Invalid AddScriptResultMark : "+ N + text + N + 
                " the name \""+ scriptName + "\" on line [" + lineNumber 
                + "] is invalid", 
              text, 
              lineNumber, 
              e );
    ...
    public static class EvalScriptMark
    {
            ...
            VarNameAudit nameAudit )
        {
            ...
            return new EvalScript( markText, lineNumber, scriptName, input, isRequired );
        }
    }
    ...
    public static class TailorDirectiveMark
    {
        ...
        public static TailorDirective of( 
            String text, int lineNumber, VarNameAudit nameAudit )
        {
        	if( ! text.startsWith( OPEN_TAG ) )
            {
            ...
            return new TailorDirective( text, lineNumber, tag ); //, input, isRequired );
        }
    }
