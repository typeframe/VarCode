...
{    
	...
	private static final VarContext PARSE_CONTEXT = 
		new VarContext();
    ...
    {   
        ...
        if( formMarkup.getAllMarks().length == 0 )
        {   //there are NO marks (its just static text) 
            return new Form.StaticForm( lineNumber, text );
        }
        //get the tail
        ...
        {   //each Form instance doesnt have a tail
            ...
            VarForm vf = new VarForm(
                ...
                name, 
                formMarkup,
                new SeriesOfForms.AfterEach( theTail ) );
            return vf;
        }
        ...
        VarForm vf = new VarForm( 
            ...
            name, 
            formMarkup, 
            new SeriesOfForms.BetweenTwo( tailText ) );
        return vf;        
    }
